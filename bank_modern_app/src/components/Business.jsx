...
const FeatureCard = ({ icon, title, content, index }) => (
  <div
    ...
    <div className="flex-1 flex flex-col ml-3">
      <h4 className="font-poppins text-white font-semibold font-[18px] leading-[23px] mb-1">
        {title}
      </h4>
      <p className="font-poppins text-dimWhite font-normal font-[16px] leading-[24px] mb-1">
        {content}
      </p>
    </div>
  </div>
