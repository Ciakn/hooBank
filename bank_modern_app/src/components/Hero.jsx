...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col `}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:p-16 px-1`}>
      ...
      <div className={`flex flex-row justify-between items-center w-full `}>
        <h1
          className={`flex-1 font-poppins font-semibold ss:text-[42px]
           ss:leading-[45px] text-[32px] text-white`}>
      ...
      <h1
        className={` w-full font-poppins font-semibold ss:text-[42px]
         ss:leading-[25px] text-[52px] text-white`}>
        Payment Method
      </h1>
    ...
    <div className={` flex-1 flex ${styles.flexCenter} md:my-0 m-10`}>
      ...
      />
      <div
        className={`absolute  w-[40%] h-[40%] rounded-full bottom-40  top-0 white__gradient z-[0]`}
      />
      <div
